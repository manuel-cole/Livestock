...
$sql="SELECT * FROM livestock WHERE YEAR(date) = YEAR(CURRENT_DATE()) AND MONTH(date) = '$month' ";
...
<tbody>       
    ...
    $result = mysqli_query($con,"SELECT * FROM livestock WHERE YEAR(date) = YEAR(CURRENT_DATE()) AND MONTH(date) = '$month'  ");
...
echo "<h3><center>Records of livestock on $month_name </center></h3><br><br>";
