...
$check = mysqli_query($con, "SELECT tag_no FROM $add_goat WHERE tag_no = '$tag_no_check'") or
die(mysqli_error());
...
$sql="INSERT INTO add_goat(tag_no, Origin, Describ, Sex, Age, Status, Admin)
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-sm-12 col-xs-10">
                            <h4 class="pTitle">Enter details for the Goat and submit</h4>
                            </div>
                    </div>
