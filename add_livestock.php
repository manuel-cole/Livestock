...
$check = mysqli_query($con, "SELECT tag_no FROM $livestock WHERE tag_no = '$tag_no_check'") or
die(mysqli_error());
...
$sql="INSERT INTO livestock(type, tag_no, Origin, Describ, Sex, Age, Status, Admin)
VALUES ('$type', '$tag_no', '$origin', '$describ', '$sex', '$age', '$status', '$email')";
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-sm-12 col-xs-10">
                            <font color="black" size="20"><h2 class="pTitle">Enter details for the <?php echo "$type"; ?> and submit</h2></font>
                        </div>
                    </div>
                    ...
                    <form name="login" action="" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <div class="form-group ">
                                <input class="form-control" value="<?php echo "$type"; ?>" name="type" type="text" readonly>
                            </div>
                            <div class="form-group ">
