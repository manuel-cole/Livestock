 ...
 <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">View Livestock</a>
                </h4>
            </div>
            
                <div class="panel-body">
                <form name="view" class="form-inline" role="form" method="POST" action="view_livestock.php" target="main">
                    
                    <div class="form-group">
                        <label for="live">Livestock:</label>
                        <select name="view" style="width: 240px" class="form-control" required>
                    ...
                    <button name="View_livestock" style="float: right;" type="submit" class="btn btn-info">View Livestock</button>
                </form>
        ...
        <a target="_top" href="adminpage.php" class="btn btn-block">Go Back</a>
    </div>
